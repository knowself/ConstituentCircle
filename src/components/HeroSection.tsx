...
const HeroSection: React.FC = () => {
  return (
    // Changed py-* to pb-* to remove top padding and reduce gap below header
    <div className="bg-background-light dark:bg-background-dark text-text-dark dark:text-text-light pb-12 sm:pb-16 md:pb-20 lg:pb-24 mt-4">
